...
\begin{itemize}
	...
	\item \LaTeX\ : É um sistema que permite a elaboração de textos em alta qualidade, através do programa de diagramação de textos TEX. Utilizado no desenvolvimento da parte escrita da monografia. 
\end{itemize}
