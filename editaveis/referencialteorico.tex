...
Para ``confidencialidade interna e confidencial``, aplica-se os mesmos conceitos das anteriores, exceto se a ocorrência de um determinado ataque ou erro pode causar vantagens a concorrentes e perda de usuários e clientes. 
\section{Gráfico de interdependência entre metas flexíveis - SIGs}

Os subtipos de conceitos que compõem a definição de segurança são abstraídos e tratados como metas flexíveis. Para então serem modelados e tratados no SIG.
