...
São os requisitos funcionais de uma aplicação de software, está diretamente ligado ao comportamento do software e a interação do usuário com o software.
