...
O termo FURPS é um acrônimo que define um modelo de atributo de qualidade, esse acrônimo é composto por cinco atributos de qualidade, sendo eles: (i) Funcionalidade (\textit{Functionality}), (ii) Usabilidade (\textit{Usability}), Confiabilidade (\textit{Reliability}), Desempenho (\textit{Performance}) e Suportabilidade (\textit{Supportability}) \cite{umar2011analyzing}.
