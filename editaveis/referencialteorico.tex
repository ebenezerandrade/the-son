...
Para o desenvolvimento da monografia foi realizado várias atividades, essas atividades seguiram um fluxo 

\begin{figure}[h!]
	\centering
	\includegraphics[keepaspectratio=true,scale=0.7]{figuras/PDM-TCC1.PNG}
	\caption{Atividades do processo de desenvolvimento da monografia para o TCC 2}
	\label{PDM-TCC1}
\end{figure}
