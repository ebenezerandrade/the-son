...
\begin{table}[h!]
	...
	\begin{tabular}{|l|l|}
		\hline
		\textbf{Responsabilidades} & \textbf{Colaboradores} \\ \hline
		\begin{tabular}[c]{@{}l@{}}- Cria e inicializa o controlador associado\\ - Exibe informações ao usuário\\ - Implementa o procedimento de atualização\\ - Recupera dados do modelo\end{tabular} & \begin{tabular}[c]{@{}l@{}}Model\\ \\ Controller\end{tabular} \\ \hline
	\end{tabular}
\end{table}
