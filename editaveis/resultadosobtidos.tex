...
Ao aplicar as personas para validação do catálogo observou-se que o catálogo trás uma visão premilinar da segurança não somente do sistema mas também aspectos de segurança da informação.
